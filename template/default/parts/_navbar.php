...
HTML;
          ...
          <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-blue-lighter dropdown-menu-lg-right" aria-labelledby="dropdownMenuButton">   
                  <a class="dropdown-item" href="index.php?p=penerimaankunjungan">Penerimaan Kunjungan</a>
                  <a class="dropdown-item" href="index.php?p=pendaftarankeanggota">Pendaftaran Keanggota</a>
                  <a class="dropdown-item" href="index.php?p=peminjaman">Peminjaman Koleksi Poltekip</a>
                  <a class="dropdown-item" href="index.php?p=pengembalian">Pengembalian Koleksi Poltekip</a>
                  <a class="dropdown-item" href="index.php?p=penelusuran">Penelusuran Informasi Poltekip</a>
                  <a class="dropdown-item" href="index.php?p=kunjunganpusataka">Penerimaan Kunjungan Pemustaka di Perpustakaan Poltekip</a>
                  <a class="dropdown-item" href="index.php?p=aksesinternet">Akses Internet Poltekip</a>
                  <a class="dropdown-item" href="index.php?p=layananfotokopi">Layanan Fotokopi Koleksi Perpusatakaan Poltekip</a>
                </div>
            </li>
            <li class="nav-item dropdown">
              <?php
